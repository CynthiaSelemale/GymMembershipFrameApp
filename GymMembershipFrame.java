...
public class GymMembershipFrame extends JFrame{
   //Panels:
    ...
    private JPanel personalTrainingOptionPn1;
    ...
    private JLabel personalTrainingOptionLb1;
    private JLabel contractsTypeLb1;
    ...
    public GymMembershipFrame(){
        ...
        personalTrainingOptionPn1 = new JPanel(new FlowLayout(FlowLayout.LEFT));
        membershipPn1  = new JPanel(new GridLayout(2, 1, 1, 1));
        membershipPn1.setBorder(new TitledBorder( new LineBorder(Color.BLACK,1), "Contract details"));
        ...
        contractsTypeLb1 = new JLabel("Type of contract:      ");
        personalTrainingOptionLb1 = new JLabel("Select the checkbox if you need a personal trainer:");
        ...
        //Take note that we have panels within panels hence the client
        //panel adds the name, surname, idNo and gender panel inside the client panel
        ...
        contractsPn1.add(contractsTypeLb1);
        contractsPn1.add(monthToMonthRadBtn);//-->Third collecive button:
        contractsPn1.add(sixMonthsRadBtn);
        contractsPn1.add(annualRadBtn);
        
        personalTrainingOptionPn1.add(personalTrainingOptionLb1);
        personalTrainingOptionPn1.add(personalTrainerCheckBox);
        
        membershipPn1.add(contractsPn1);
        membershipPn1.add(personalTrainingOptionPn1);
        
        
        commentsPn1.add(scrollableTextArea);//-->Fourth Collective Panel:
        ...
        btnsPn1.add(applyBtn);//-->Fifth collective panel
